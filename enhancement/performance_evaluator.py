...
results = [] 
for product_data in product_datas[1:2]:
    ...
    training_transactions_users_ids, test_user_ids = train_test_split(list(user_transactions.keys()), test_size=.2, random_state=42)
